  ...
  try {
    ...
    if (action === "seed") {
      const seeds = [
        ...
        { title: "Set up @bosseramabel TikTok profile", stream: "Boss Era", order: 1 },
        { title: "Post 3× per week on Boss Era", stream: "Boss Era", order: 2 },
        { title: "Plan first Boss Era content series", stream: "Boss Era", order: 3 },
        { title: "Reach first 100 followers", stream: "Boss Era", order: 4 },
        { title: "Film first Boss Era brand video", stream: "Boss Era", order: 5 },
